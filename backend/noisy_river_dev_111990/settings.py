"""
Django settings for noisy_river_dev_111990 project.
...
ROOT_URLCONF = 'noisy_river_dev_111990.urls'
...
WSGI_APPLICATION = 'noisy_river_dev_111990.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "noisy_river_dev_111990 API",
    "DESCRIPTION": "API documentation for noisy_river_dev_111990 App",
    "VERSION": "v1",
}
